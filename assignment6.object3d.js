...
class ShadedObject3D extends Object3D { 
    ...
    createVAO( gl, shader )
    {
        ...
        if (location >= 0) {
            ...
            gl.vertexAttribPointer(shader.getAttributeLocation("a_position"), this.num_components_vec3, gl.FLOAT, false, stride, offset);
            offset += (((this.vertices.length * 3) / num_total_components) * Float32Array.BYTES_PER_ELEMENT);
        }
        ...
        if (location >= 0) {
            ...
            gl.vertexAttribPointer(shader.getAttributeLocation("a_normal"), this.num_components_vec3, gl.FLOAT, false, stride, offset);
            offset += (((this.vertices.length * 3) / num_total_components) * Float32Array.BYTES_PER_ELEMENT);
        }
        ...
        if (location >= 0 && this.material.hasTexture()) {
            ...
            gl.vertexAttribPointer(shader.getAttributeLocation("a_tangent"), this.num_components_vec3, gl.FLOAT, false, stride, offset);
            offset += (((this.vertices.length * 3) / num_total_components) * Float32Array.BYTES_PER_ELEMENT);
        ...
        if (location >= 0 && this.material.hasTexture()) {
            ...
            gl.enableVertexAttribArray(shader.getAttributeLocation("a_texture_coord"));
            gl.vertexAttribPointer(shader.getAttributeLocation("a_texture_coord"), this.num_components_vec2, gl.FLOAT, false, stride, offset);
            offset += (((this.vertices.length * 2) / num_total_components) * Float32Array.BYTES_PER_ELEMENT);
        }
    ...
    render( gl )
    {
        ...
        if (this.material.hasMapKD()) {
            ...
            this.shader.setUniform1i("u_material.map_kD", this.material.getMapKD());
