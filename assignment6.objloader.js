...
class OBJLoader {
    ...
    load( gl ) {
        ...
        let vertex_data = []
        // First pass all the vertex_position, and then pass all vertex_normal
        for (let i = 0; i < vertex_positions.length; i ++) {
        ...
        if (material.hasTexture()) {
            ...
            for (let i = 0; i < vertex_tangents.length; i ++) {
                vertex_data.push(vertex_tangents[i]);
            }
            for (let i = 0; i < vertex_texture_coords.length; i ++) {
                vertex_data.push(vertex_texture_coords[i]);
            }
        }
